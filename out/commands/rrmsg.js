...
var Command = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var guild, mentions, channels, targetChannel, text, newMessage;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        targetChannel = channels.first() || message.channel;
                        if (channels.first()) {
                            args.shift();
                        }
                        text = args.join(' ');
                        return [4 /*yield*/, targetChannel.send(text)];
                    case 1:
                        newMessage = _b.sent();
                        ...
                        rr_1.addToCache(guild.id, newMessage);
