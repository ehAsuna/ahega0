...
var Command = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var content, image, embed, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        if (message.content.toLowerCase().includes("@everyone")) {
                            return [2 /*return*/, message.reply(", seriously someone get a mod he just tried to ping everyone. :rollingeyes:")];
                        }
                        content = args.slice(0).join(' ');
                        return [4 /*yield*/, api.generate("phcomment", { image: message.author.avatarURL(), text: content, username: message.author.tag })];
                    case 1:
                        image = _b.sent();
