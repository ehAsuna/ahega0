...
var Command = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, image, embed;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user = message.mentions.users.first();
                        return [4 /*yield*/, api.generate("threats", { url: user.avatarURL() })];
                    case 1:
                        image = _b.sent();
                        if (!user.avatarURL())
                            return [2 /*return*/, message.reply(":x: " + user.tag + " profile photo not found.").then(function (msg) { msg.delete({ timeout: 3000 }); }).catch(console.error)];
                        if (user.id == message.author.id)
                            return [2 /*return*/, message.reply('You cannot murder yourself :(').then(function (msg) { msg.delete({ timeout: 3000 }); }).catch(console.error)];
