    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                lo = new discord_js_1.default.MessageEmbed()
                    .setDescription("Please wait...")
                    .setTimestamp();
                axios_1.default
                    .get('https://simplescraper.io/api/GcQKHOzbFUB2yieyUPD7?apikey=VaEHAkC1RXtXT1owR7AY4YHBpZRcxEJt&run_now=true&limit=100')
                ...
                message.channel.send(lo).then(function (m) {
                    superagent_1.default.get('https://simplescraper.io/api/GcQKHOzbFUB2yieyUPD7?apikey=VaEHAkC1RXtXT1owR7AY4YHBpZRcxEJt&run_now=true&limit=100').query({ type: 'ass' }).end(function (err, response) {
                        var embed_nsfw = new discord_js_1.default.MessageEmbed()
