...
var Command = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var reasons, _b, guild, staff, target, reason, validReasons, key, previousMutes, currentlyMuted, duration, expires, mutedRole, targetMember;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = message, guild = _b.guild, staff = _b.author;
                        ...
                        return [4 /*yield*/, muted_schema_1.default.find({
                                userId: target.id,
                            })];
                    case 1:
                        previousMutes = _c.sent();
                        currentlyMuted = previousMutes.filter(function (mute) {
                        ...
                        duration = reasons[reason] * (previousMutes.length + 1);
                        expires = new Date();
                        expires.setHours(expires.getHours() + duration);
                        mutedRole = guild.roles.cache.find(function (role) {
                    ...
                    case 2:
                        targetMember = (_c.sent()).get(target.id);
                        targetMember.roles.add(mutedRole);
                        return [4 /*yield*/, new muted_schema_1.default({
                                userId: target.id,
                                guildId: guild.id,
                                reason: reason,
                                staffId: staff.id,
