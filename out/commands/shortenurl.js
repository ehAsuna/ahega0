...
var tinyurl_api_1 = __importDefault(require("tinyurl-api"));
var Command = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        reg = new RegExp(/^((?:https?:)?\/\/)?((?:www|m)\.)?/g);
                        if (reg.test(args[0]) == false)
                            return [2 /*return*/, message.reply('Please send a valid URL to shorten.')];
                        return [4 /*yield*/, tinyurl_api_1.default(args[0])];
                    case 1:
                        url = _b.sent();
